  ...
  <div>
    <v-container fluid>
      <DialogContainer :dialog="dialog">
        <EmpreendimentosTabs :tab="tab" :mode="mode" :usuario="usuario" />
...
import EmpreendimentosTabs from "@/components/gerenciamento/empreendimentos/EmpreendimentosTabs";
...
export default {
  components: { DialogContainer, EmpreendimentosTabs },
  mixins: [dialog],
  data: () => ({
    mode: "submit",
    tab: {
