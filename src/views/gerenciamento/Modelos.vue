  ...
  <div>
    <v-container fluid>
      <DialogContainer :dialog="dialog">
        <ModelosTabs :tab="tab" :mode="mode" :usuario="usuario" />
...
import ModelosTabs from "@/components/gerenciamento/modelos/ModelosTabs";
...
export default {
  components: { DialogContainer, ModelosTabs },
  mixins: [dialog],
  data: () => ({
    mode: "submit",
    tab: {
